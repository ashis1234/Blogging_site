# Generated by Django 3.0.2 on 2021-01-06 05:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linkdin_url', models.CharField(max_length=250, null=True)),
                ('facebook_url', models.CharField(max_length=250, null=True)),
                ('github_url', models.CharField(max_length=250, null=True)),
                ('instagram_url', models.CharField(max_length=250, null=True)),
                ('twiter_url', models.CharField(max_length=250, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dislikes', models.ManyToManyField(related_name='blog_posts1', to=settings.AUTH_USER_MODEL)),
